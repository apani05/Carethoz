...
export default function TransportPage({navigation}){
    ...
    <Text style={{textAlign: "center", margin: 15, fontSize: 20, fontWeight: "600"}}>Mobility</Text> 
    <View>
    <Image source ={require("../assets/Transportation.png")} style={{width: DeviceWidth, height: DeviceWidth*0.55,margin:1, borderRadius: 20}}></Image>
    ...
    <View>
        ...
        <View style={{flexDirection: 'row'}}>
                ...
                <TouchableOpacity onPress={() => Linking.openURL('lyft://app')} style={{width:DeviceWidth*0.28,height: DeviceWidth*0.28,margin:10,backgroundColor: 'lightgrey', borderWidth:1, borderColor: 'grey',}}
              >
